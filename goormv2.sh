...
wget https://github.com/splenddd/goorm-v2ray-1/blob/master/v2ray

#设置运行权限
chmod +x /v2ray/v2ray
rm -f /v2ray/v2ctl
#wget https://github.com/byxiaopeng/goorm-v2ray/raw/master/v2ctl
wget https://github.com/splenddd/goorm-v2ray-1/blob/master/v2ctl

chmod +x /v2ray/v2ctl
rm -f /v2ray/config.json
#wget https://github.com/byxiaopeng/goorm-v2ray/raw/master/config.json
wget https://github.com/splenddd/goorm-v2ray-1/blob/master/config.json
# 开始后台运行
